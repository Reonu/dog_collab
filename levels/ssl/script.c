...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, 35, -6482, -240, 0, 0, 0, 0x00000000, bhv2dSnapper),
		MARIO_POS(0x01, 0, -5572, -2498, 92),
		OBJECT(MODEL_NONE, 0, -6482, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
